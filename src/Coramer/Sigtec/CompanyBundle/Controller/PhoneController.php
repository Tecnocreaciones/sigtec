...
use Coramer\Sigtec\CompanyBundle\Form\PhoneType;
...
class PhoneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CoramerSigtecCompanyBundle:Phone')->findAll();
     ...
     * @Method("POST")
     * @Template("CoramerSigtecCompanyBundle:Phone:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CoramerSigtecCompanyBundle:Phone')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CoramerSigtecCompanyBundle:Phone:edit.html.twig")
     */
