...
class ProductionLevelController extends BaseController
{
    ...
    public function createAction(Request $request) {
        ...
        $this->dispatchReportTechnicalEvent(Events::REPORT_TECHNICAL_PRODUCTION_LEVEL_PRE_CREATE, $reportTechnical);
        ...
        if ($request->isMethod('POST') && $form->submit($request)->isValid()) {
            ...
            $reportTechnical->addProductionLevel($resource);
            
            $this->dispatchReportTechnicalEvent(Events::REPORT_TECHNICAL_PRODUCTION_LEVEL_POST_CREATE, $reportTechnical);
    ...
    public function deleteAction(Request $request) {
        ...
        $this->dispatchReportTechnicalEvent(Events::REPORT_TECHNICAL_PRODUCTION_LEVEL_PRE_DELETE, $reportTechnical);
        ...
        if($request->isXmlHttpRequest()){
            ...
            $reportTechnical->removeProductionLevel($resource);
            
            $this->dispatchReportTechnicalEvent(Events::REPORT_TECHNICAL_PRODUCTION_LEVEL_POST_DELETE, $reportTechnical);
    ...
    public function updateAction(Request $request) {
        ...
        $this->dispatchReportTechnicalEvent(Events::REPORT_TECHNICAL_PRODUCTION_LEVEL_PRE_UPDATE, $reportTechnical);
        ...
        if (($request->isMethod('PUT') || $request->isMethod('POST')) && $form->submit($request)->isValid()) {
            ...
            $this->dispatchReportTechnicalEvent(Events::REPORT_TECHNICAL_PRODUCTION_LEVEL_POST_UPDATE, $reportTechnical);
