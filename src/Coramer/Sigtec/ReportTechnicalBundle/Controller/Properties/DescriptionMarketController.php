...
/**
 * Controlador de las decripciones de los mercados
 *
 * @author Carlos Mendoza <inhack20@tecnocreaciones.com>
 */
class DescriptionMarketController extends BaseController
{
    public function listAction(Request $request) {
        ...
        $view = $this
            ->view()
        ;
        $view->setData($reportTechnical->getDescriptionMarkets());
    ...
    function getFormAction(Request $request)
    {
        ...
        $resource->setReportTechnical($reportTechnical);
        $form = $this->getForm($resource);
        return $this->render('CoramerSigtecWebBundle:Backend:ReportTechnical/Properties/DescriptionMarket/form.html.twig',array(
            'form' => $form->createView(),
