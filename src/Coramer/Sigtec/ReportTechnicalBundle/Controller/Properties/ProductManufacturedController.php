 ...
 */
class ProductManufacturedController extends BaseController
{
    ...
    function getFormAction(Request $request)
    {
        ...
        $resource = $this->createNew();
        $form = $this->getForm($resource);
        return $this->render('CoramerSigtecWebBundle:Backend:ReportTechnical/Properties/ProductManufactured/form.html.twig',array(
            'form' => $form->createView(),
