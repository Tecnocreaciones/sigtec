...
class OtherMarketController extends BaseController
{
   ...
   public function createAction(Request $request) {
        ...
        $this->dispatchReportTechnicalEvent(Events::REPORT_TECHNICAL_OTHER_MARKET_PRE_CREATE, $reportTechnical);
        ...
        if ($request->isMethod('POST') && $form->submit($request)->isValid()) {
            ...
            $reportTechnical->getGrowthPotential()->addOtherMarket($resource);
            
            $this->dispatchReportTechnicalEvent(Events::REPORT_TECHNICAL_OTHER_MARKET_POST_CREATE, $reportTechnical);
    ...
    public function updateAction(Request $request) {
        ...
        $this->dispatchReportTechnicalEvent(Events::REPORT_TECHNICAL_OTHER_MARKET_PRE_UPDATE, $reportTechnical);
        ...
        if (($request->isMethod('PUT') || $request->isMethod('POST')) && $form->submit($request)->isValid()) {
            ...
            $this->dispatchReportTechnicalEvent(Events::REPORT_TECHNICAL_OTHER_MARKET_POST_UPDATE, $reportTechnical);
    ...
    public function deleteAction(Request $request) {
        ...
        $this->dispatchReportTechnicalEvent(Events::REPORT_TECHNICAL_OTHER_MARKET_PRE_DELETE, $reportTechnical);
        ...
        if($request->isXmlHttpRequest()){
            ...
            $this->dispatchReportTechnicalEvent(Events::REPORT_TECHNICAL_OTHER_MARKET_POST_DELETE, $reportTechnical);
